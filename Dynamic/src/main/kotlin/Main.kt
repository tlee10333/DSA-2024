...
fun main() {
    var x = Matrix(1)
    var y = Matrix (1)
    x.matrix[0]= arrayOf(2)
    y.matrix[0]= arrayOf(10)
    println(x.strassenMultiply(y)?.matrix.contentDeepToString())



    x = Matrix(2)
    y = Matrix (2)
    x.matrix[0]= arrayOf(1,2)
    x.matrix[1]= arrayOf(4,5)
    y.matrix[0]= arrayOf(10,11)
    y.matrix[1]= arrayOf(20,21)
    var d = x.strassenMultiply(y)
    ...
    //println(x.add(y)?.matrix.contentDeepToString())
